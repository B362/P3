...
kp1 = 141; kv1 = 1410; kp2 = 141; kv2 = 1410; kp3 = 141; kv3 = 1410;
ki1 = 0.8*14100; ki2 = 0.8*14100; ki3 = 0.8*14100;
%kp1 = 3.015; kv1 = 10*3.5; kp2 = 3.015; kv2 = 10*3.5; kp3 = 3.015; kv3 = 10*3.5;
%kp1 = 3.015; kv1 = 3.5; kp2 = 3.015; kv2 = 3.5; kp3 = 3.015; kv3 = 3.5;
%kp1 = 25; kv1 = 10; kp2 = 25; kv2 = 10; kp3 = 25; kv3 = 10;
...
iperr1(1) = 0; iperr2(1) = 0; iperr3(1) = 0;

% Disturbance torque taud
taud1 = 0; taud2 = 1; taud3 = 1;
...
taup1 = kp1*(theta1ref(ii)-theta1(ii))-kv1*dtheta1(ii)+kv1*(omega1ref(ii))+acc1ref(ii);%+ki1*iperr1(ii);
taup2 = kp2*(theta2ref(ii)-theta2(ii))-kv2*dtheta2(ii)+kv2*(omega2ref(ii))+acc2ref(ii);%+ki2*iperr2(ii);
taup3 = kp3*(theta3ref(ii)-theta3(ii))-kv3*dtheta3(ii)+kv3*(omega3ref(ii))+acc3ref(ii);%+ki3*iperr3(ii);
tau = alpha*[taup1;taup2;taup3]+[taud1;taud2;taud3]+0.75*beta; %With or without the compensator
%simulation step
...
% used for the PI controller -- the position error integrated
perr1(ii) = theta1ref(ii)-theta1(ii);
perr2(ii) = theta2ref(ii)-theta2(ii);
perr3(ii) = theta3ref(ii)-theta3(ii);
iperr1(ii+1) = perr1(ii)*dt + iperr1(ii);
iperr2(ii+1) = perr2(ii)*dt + iperr2(ii);
iperr3(ii+1) = perr3(ii)*dt + iperr3(ii);
